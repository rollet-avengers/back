...
import com.roulette.roulette.myPage.myDTO.MemberDTO;
import com.roulette.roulette.myPage.myDTO.MyCodeDTO;
import com.roulette.roulette.myPage.myDTO.MyPageDTO;
...
//    public void testGetMemberDTO(){
//        Long memberId = 1L;
//        Member member = new Member("john", "john@naver.com");
//        when(myMemberRepository.findById(memberId)).thenReturn(Optional.of(member));
//        //테스트
//        MemberDTO memberDTO = myPageService.getMemberDTO(memberId);
//        //결과 검증
...
//    }
    ...
    public void testGetMyCodeData() {
        ...
        // 결과 검증
        assertEquals(codeList.get(0).getCodeUrl(), myCodeDTO.getCodeList());
//        assertEquals(codeList.get(0).getCreateTime(), myCodeDTO.getCodeList());
